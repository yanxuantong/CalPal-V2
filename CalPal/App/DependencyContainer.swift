...
struct DependencyContainer {
    ...
    static var live: DependencyContainer {
        ...
        return DependencyContainer(calendarRepository: calendarRepository, commandPipeline: pipeline, speechService: speech, modelProvider: modelProvider, preferenceSummaryStore: prefs, capabilityService: capability)
    }
    ...
    static func mock(now: Date = PreviewFixtures.now) -> DependencyContainer {
        ...
        return DependencyContainer(calendarRepository: repo, commandPipeline: pipeline, speechService: speech, modelProvider: model, preferenceSummaryStore: prefs, capabilityService: capability)
    }
}
