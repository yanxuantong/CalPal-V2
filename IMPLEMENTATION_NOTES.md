...
- Press-and-hold voice uses `SFSpeechRecognizer` and `AVAudioEngine`; text/manual fallback is preserved for denied permissions, unavailable locales, no transcript, or simulator/device microphone limits.
...
- Real microphone transcription and real EventKit create/modify/delete still need device/manual QA with actual calendars and permissions.
