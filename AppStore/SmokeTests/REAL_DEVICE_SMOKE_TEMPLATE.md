# CalPal 1.0 TestFlight Real-Device Smoke Evidence
...
iOS version: TODO
Tester: TODO
TestFlight build evidence: TODO
...
Record the TestFlight build number, device model, iOS version, and any observed issues. Do not change `Result` to `PASS` until every checklist item is complete and any release-blocking issues are resolved.
