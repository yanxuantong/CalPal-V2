...
- Run each XCTest suite on iOS Simulator. The full suite currently covers 72 tests.
...
- `V2UsabilityRegressionTests`: 22 passed, 0 failed.
...
- Full Simulator XCTest: 72 passed, 0 failed.
