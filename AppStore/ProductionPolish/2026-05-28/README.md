...
- Run each XCTest suite on iOS Simulator. The full suite currently covers 75 tests.
...
- `V2UsabilityRegressionTests`: 25 passed, 0 failed.
...
- Full Simulator XCTest: 75 passed, 0 failed.
