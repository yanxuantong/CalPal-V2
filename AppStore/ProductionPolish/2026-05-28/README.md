...
- Run each XCTest suite on iOS Simulator. The full suite currently covers 73 tests.
...
- `V2UsabilityRegressionTests`: 23 passed, 0 failed.
...
- Full Simulator XCTest: 73 passed, 0 failed.
