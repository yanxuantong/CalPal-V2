...
- Run each XCTest suite on iOS Simulator. The full suite currently covers 85 tests.
...
- `V2UsabilityRegressionTests`: 35 passed, 0 failed.
...
- Full Simulator XCTest: 85 passed, 0 failed.
