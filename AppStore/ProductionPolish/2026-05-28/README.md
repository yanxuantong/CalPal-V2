...
- Run each XCTest suite on iOS Simulator. The full suite currently covers 74 tests.
...
- `V2UsabilityRegressionTests`: 24 passed, 0 failed.
...
- Full Simulator XCTest: 74 passed, 0 failed.
